...
$(document).ready(function(e){
  ...
  function add_customer(data,action)
  {
...
$('#add_holiday').submit(function(e){
 ...
 /*  html+=`<div class="iq-card-body">
  ...
  $('#add_advertisement').submit(function(e){
    e.preventDefault();
    var data=new FormData(this);
    var action=$(this).attr('action');
    ajaxcall(data,action,function(data)
...
var data={user_id:$(this).siblings('.userid').val()};
ajaxcall1(data,'activate_user',function(data){
  if(data==1)
  {
...
$('.repeat_field_stock').prepend(html);
  ...
  $('#add_stock').submit(function(e){
    ...
    ajaxcall(data,action,function(data)
    {
      ...
      if(data==1)
      {
      window.location.href=base_url+"admin/stock-list/"+agent_id;
      }
      else
      {
        swal("Failed");
  ...
  $('#add_channel_video').submit(function(e){
    e.preventDefault();
    var data=new FormData(this);
    var action=$(this).attr('action');
    ajaxcall(data,action,function(data)
