                        ...
                        <div class="table-responsive ">
                           <table class="table mb-0 table-borderless">
                             ...
                             <?php 
                               ...
                               <tr>
                                 ...
                                 <td><?php echo $details->name;?></td>
                                  ...
                                  <!--  <span class="table-remove"><button type="button"
                                       ...
                                       <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('admin/update-shop-category/'.$details->id))?>">Update</a></button></span>
                                       <span class="table-remove"><input type="hidden" name="deltype" class="deltype" value="shop-category">
                               ...
                               <tr><td>Shop Category List Not Available</td></tr>
                               <?php
                               }?>
