 ...
 <div class="wrapper">
      ...
      <div class="iq-sidebar">
         <div class="iq-sidebar-logo d-flex justify-content-between">
            ...
            <img src="<?php echo base_url()?>assets/img/admin/logo.gif" class="img-fluid" alt="">
            <span>ADIS</span>
            </a>
                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
					...
					<!--   <li><a href="<?php echo site_url('admin/orders')?>" class="iq-waves-effect"><i class="las la-sms"></i><span>Orders</span></a></li> -->
                        ...
                        <ul id="user-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                           ...
                           <li><a href="<?php echo site_url('admin/shop-list')?>">Shops List</a></li>
                           <li><a href="<?php echo site_url('admin/individual-list')?>">Individual List</a></li>
                           <li><a href="<?php echo site_url('admin/free-list')?>">Free List</a></li>
                        </ul>
                     </li>
					  <!--    <li>
                    ...
                    <!--  <li><a href="<?php echo site_url('admin/product-add')?>">Add Product</a></li> -->
                     ...
                     <li><a href="<?php echo site_url('admin/add-job-category')?>">Add Job Category</a></li>
                     <li><a href="<?php echo site_url('admin/add-shop-category')?>">Add Shop Category</a></li>
                     <li><a href="<?php echo site_url('admin/add-advertisement')?>">Add Advertisement</a></li>
                     <li><a href="<?php echo site_url('admin/add-channel-videos')?>">Add Channel Videos</a></li>
