                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body tasks-box">
                              <div class="d-flex align-items-center">                                 
                                 ...
                                 <div>
                                    <h6>Shops:</h6>
                                    <h3><?php echo $dash_count['shop'];?></h3>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body tasks-box">
                              <div class="d-flex align-items-center">                                 
                                 ...
                                 <div>
                                    <h6>Individuals:</h6>
                                    <h3><?php echo $dash_count['individual'];?></h3>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body tasks-box">
                              <div class="d-flex align-items-center">                                 
                                 ...
                                 <div>
                                    <h6>Free:</h6>
                                    <h3><?php echo $dash_count['free'];?></h3>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body tasks-box">
                              <div class="d-flex align-items-center">                                 
                                 ...
                                 <div>
                                    <h6>Orders:</h6>
                                    <h3>0<?php //echo $dash_count->orders;?></h3>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="row">
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">New Individual Customers</h4>
                        </div>
                     </div>
                     <div class="iq-card-body">
                        <ul class="task-lists m-0 p-0">
                           <?php if(isset($individual_list))
                           {foreach($individual_list as $detail){
                              ?>
                           <li class="d-flex mb-4 align-items-center">
                              ...
                              <div class="media-support-info ml-3">
                                 <h6><?php echo $detail->display_name?></h6>
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     ...
                     <div class="iq-card-body">
                        ...
                        <?php if(isset($shop_list))
                           ...
                           { $i=1;
                              foreach($shop_list as $detail){
                              ?>
                           <li class="d-flex mb-4 align-items-center">
                              <div class="user-img img-fluid"><img src="<?php echo base_url()?>images/admin/user/01.jpg" alt="story-img" class="rounded-circle avatar-40"></div>
                              <div class="media-support-info ml-3">
                                 <h6><?php echo $detail->shop_name;?></h6>
              ...
              <div class="col-md-4">
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">New Free Customers</h4>
                        </div>
                     </div>
                     <div class="iq-card-body">
                        <ul class="perfomer-lists m-0 p-0">
                           <?php if(isset($free_list)){
                              foreach($free_list as $detail){?>
                              <li class="d-flex mb-4 align-items-center">
                                 <div class="user-img img-fluid"><img src="<?php echo base_url()?>images/admin/user/01.jpg" alt="story-img" class="rounded-circle avatar-40"></div>
                                 <div class="media-support-info ml-3">
                                    <h6><?php echo $detail->display_name?></h6>
